...
namespace EpgTimer
{
    ...
    public enum CtrlCmd : uint
    {
        ...
        CMD_EPG_SRV_GET_REC_SETTING = 2021,
    ...
    public class CtrlCmdUtil
    {
        ...
        public ErrCode SendGetRecSetting(ref RecSettingData val) { object o = val; return ReceiveCmdData2(CtrlCmd.CMD_EPG_SRV_GET_REC_SETTING, ref o); }
#region // コマンドバージョン対応版
